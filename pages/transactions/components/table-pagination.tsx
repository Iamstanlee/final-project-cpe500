...
export function TablePagination<TData>({ table }: PaginationProps<TData>) {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 px-4 pb-4">
      <div className="flex-1 text-sm text-muted-foreground">
        {table.getFilteredSelectedRowModel().rows.length} of {table.getFilteredRowModel().rows.length} row(s) selected.
      </div>
      <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-0 md:space-x-6 lg:space-x-8">
